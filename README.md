...
<html>
    ...
    <body>
                ...
                <div class="dog-breeds-4_description">
                    ...
                    <div class="breed-characteristics">
                        ...
                        <ul>
                            ...
                            <li>Лучше подходит для опытных владельцев</li>
                        </ul>
                    </div>
                </div>
            </section>
            ...
            <div class="container">
                <div class="content">
                    <div class="right-side">
                        <div class="topic-text">Консультация по выбору породы</div>
                        <p>
                            Не можете определиться с породой собаки? Хотите узнать больше об особенностях содержания? Заполните форму ниже, и наши кинологи помогут вам выбрать идеального питомца!
                        </p>
                        <form action="#">
                            <div class="input-box">
                            ...
                            <div class="input-box">
                                <input type="text" placeholder="Какую породу рассматриваете?" />
                            </div>
                            <div class="input-box message-box">
                                <textarea placeholder="Ваши вопросы и пожелания"></textarea>
                            </div>
                            <div class="button">
                                <input type="button" class="btn" value="Получить консультацию" />
                            </div>
                        </form>
                    </div>
                </div>
        ...
        <div class="podval">
            <div class="footer">
                <div class="kopirate">
                    <span class="sub">© 2024 Центр кинологических исследований. Все права защищены.</span>
                    <p>Материалы сайта предназначены для ознакомления с породами собак. Перед приобретением питомца рекомендуем проконсультироваться с профессиональными кинологами.</p>
                </div>
            </div>
        </div>
        
        <script>
            // Функции для открытия/закрытия формы входа
            function openForm() {
            ...
            // Функции для бокового меню (оставлены на случай, если меню будет нужно)
            function openNav() {
            ...
            // Добавляем эмодзи собачек при загрузке страницы
